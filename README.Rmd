...
4. Submit the Assignment (you might want to review the [relevant instructions from Challenge 1](https://github.com/IBIEM/challenge_1/blob/master/README.Rmd#submitting-the-assignment) ).  You should submit the following:
  ...
  - `challenge2_functions.R` : your function definition file.
...
### SessionInfo
Including a `SessionInfo` statement at the end of your R Notebook is good reproducibility practice.  This time it is included already in `challenge3_assignment.Rmd`; next time you might not be so lucky! 
